"""
Credit goes to JSMapReduce.com for this Python code
with the exception of the 4 card straight section
"""
...
def mapper(record):
    ...
    is_flush = ( 
          ...
          (counts['D'] == 5) or 
          (counts['H'] == 5)) 
    is_straight = is_straight4 = False
    ...
    is_quad = is_trip = is_pair = is_two_pair = False 
    faces = 'A23456789TJQK' 
    ...
    if is_straight and is_flush: 
        ...
        mr.emit_intermediate('straight4', '1')
    elif is_trip: 
